...
export const FAQ_KNOWLEDGE = {
  shipping: {
    ...
    international: "We ship to over 150 countries worldwide! International shipping starts at $15 and typically takes 7-14 business days. Express international (3-5 days) available for $45.",
    tracking: "All orders include real-time tracking. You'll receive a tracking number via email within 24 hours of shipment.",
  },
  returns: {
  ...
  payment: {
    methods: "We accept all major credit cards (Visa, Mastercard, American Express, Discover), PayPal, Apple Pay, Google Pay, Venmo, and Afterpay (buy now, pay later in 4 interest-free installments).",
    security: "Your security is our priority! All payments are encrypted and processed securely through Stripe. We NEVER store your credit card information. PCI-DSS Level 1 certified.",
    installments: "Shop now, pay later! Use Afterpay or Klarna to split your purchase into 4 interest-free payments. No credit check required!",
  },
  products: {
    quality: "We source premium, sustainable materials and partner with ethical manufacturers. Every product comes with our Quality Guarantee.",
    warranty: "All products include a 1-year manufacturer warranty against defects. Extended warranties available at checkout.",
